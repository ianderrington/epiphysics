...
const Footer = forwardRef<HTMLElement, FooterProps>(({ config }, ref) => {
  ...
  return (
    <footer ref={ref} className="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800">
          ...
          <div className="flex items-center justify-center space-x-6 pt-4">
            ...
            >
              ...
              <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                <path d="M12.002 2.005c5.518 0 9.998 4.48 9.998 9.997 0 5.518-4.48 9.998-9.998 9.998-5.517 0-9.997-4.48-9.997-9.998 0-5.517 4.48-9.997 9.997-9.997zm0 1.5c-4.69 0-8.497 3.807-8.497 8.497s3.807 8.498 8.497 8.498 8.498-3.808 8.498-8.498-3.808-8.497-8.498-8.497zm1.824 4.182a2.75 2.75 0 0 1 3.85 3.85l-3.943 3.943a2.75 2.75 0 0 1-3.85-3.85l3.943-3.943zm-1.762 1.762-3.293 3.293a1.25 1.25 0 1 0 1.768 1.768l3.293-3.293a1.25 1.25 0 1 0-1.768-1.768z" strokeWidth="0" fill="currentColor"/>
              </svg>
            </a>
