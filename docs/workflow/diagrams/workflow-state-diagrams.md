...
- **WRITE operations** (`sc planning req new`, `sc planning req update`): Auto-commit to main AFTER command succeeds
- **READ operations** (`sc planning req show`, `sc planning req list`): Auto-sync from main BEFORE command executes
