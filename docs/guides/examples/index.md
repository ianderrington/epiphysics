...
sc planning req generate --count=10
...
sc planning req generate --framework=gdpr --category=privacy
sc planning req generate --framework=soc2 --category=security
```
...
sc planning req validate --all --format=json > validation-results.json
