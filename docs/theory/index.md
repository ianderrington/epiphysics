...
|------|-------|-----------|
| [Part 0: Foundations](./00_prelude.md) | What Epimechanics is and isn't | X is a representation; entities are anything representable; Epimechanics = theory, Epiphysics = experiments; all representations have epimechanical structure |
