...
[Part 1.5: Causants](./00_atomic_structure.md) develops what $\rho_{\text{ac}}$ is made of — the causal bonds, loop structures, and stability basins from which auto-causal density emerges.
...
- [Part 1.5: Causants](./00_atomic_structure.md) — what are entities *made of*? The six candidate causants.
...
[→ Part 1: Generalized Mechanics](./01_generalized_mechanics.md) | [→ Part 1.5: Causants](./00_atomic_structure.md)
