...
> **Context.** This document extends the [Causal Constituents](./00_atomic_structure.md) (Part 1.5) by showing how the medium modifies an entity's measured inertia. For the general mechanical framework, see [Part 1: Generalized Mechanics](./01_generalized_mechanics.md).
...
> **See also:** [Causal Constituents](./00_atomic_structure.md) (Part 1.5) for the six atomic quantities from which mass is composed. [Part 1: Generalized Mechanics](./01_generalized_mechanics.md) for the full tensorial treatment of $\mathcal{M}_{ij}$.
