...
> [!sidenote]
> *Why the $c^2$ form may survive coarse-graining*: The $c^2$ form may survive coarse-graining because every scale has a maximum causal propagation speed, creating an effective light-cone structure. Whether this is rigorous is an open question ([Part 5, Section 2](./epimechanics_05_ontology_and_open_questions.md)).
