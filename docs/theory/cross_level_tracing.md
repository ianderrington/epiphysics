...
> **Context.** This document extends the [Causal Constituents](./00_atomic_structure.md) (Part 1.5). For the mechanical grammar, see [Part 1: Generalized Mechanics](./01_generalized_mechanics.md). For the Representational Efficiency principle, see [Part 5](./05_ontology_and_open_questions.md).
...
> **See also:** [Causal Constituents](./00_atomic_structure.md) (Part 1.5) for the six atomic quantities. [Part 1: Generalized Mechanics](./01_generalized_mechanics.md) for the Lagrangian framework and Rayleigh dissipation. [Part 5](./05_ontology_and_open_questions.md) for the Representational Efficiency principle.
